...
def signup_window():
    ...
    ttk.Entry(master=f_signup,justify="left",width=20,textvariable=user_password_su).pack(padx=10,pady=(2, 10))
    ttk.Label(master=f_signup,text="Repeat Password", anchor="w", justify="left",width=22).pack()
    ttk.Entry(master=f_signup,justify="left",width=20,textvariable=user_password_reentry).pack(padx=10,pady=(2, 10))
